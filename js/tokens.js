...
if (!CFG.DEATH_HAZARD_RADIUS) CFG.DEATH_HAZARD_RADIUS = 5;
if (!CFG.HAZARD_EFFECT_DUR) CFG.HAZARD_EFFECT_DUR = 180; // 3 seconds at 60fps
if (!CFG.TOKEN_MIN_GAP) CFG.TOKEN_MIN_GAP = 25;
if (!CFG.TOKEN_SPAWN_CHANCE) CFG.TOKEN_SPAWN_CHANCE = 0.025;
if (!CFG.TOKEN_NO_SPAWN_ZONE) CFG.TOKEN_NO_SPAWN_ZONE = 40;
if (!CFG.HAZARD_MIN_GAP) CFG.HAZARD_MIN_GAP = 10;
if (!CFG.HAZARD_SPAWN_CHANCE) CFG.HAZARD_SPAWN_CHANCE = 0.02;
if (!CFG.HAZARD_NO_SPAWN_ZONE) CFG.HAZARD_NO_SPAWN_ZONE = 80;
if (!CFG.HAZARD_SLOW_MULT) CFG.HAZARD_SLOW_MULT = 0.55;
if (!CFG.HAZARD_SPEED_MULT) CFG.HAZARD_SPEED_MULT = 1.35;
if (!CFG.OVERLAP_MARGIN) CFG.OVERLAP_MARGIN = 15;
